...
public class updateservlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest var1, HttpServletResponse var2) throws ServletException, IOException {
      ...
      String var10 = var1.getParameter("Contact");
      String var11 = var1.getParameter("pass");
      ...
      try {
         ...
         String var15 = "UPDATE data SET fname=?,lname=?,email=?,Contact=?,pass=? WHERE Roll=?";
         ...
         var14.executeUpdate();
         var2.sendRedirect("student_login.html");
